...
if df is not None:
    ...
    if len(data) > 1:
        ...
        with col_hist:
            ...
            fig_hist.add_trace(go.Scatter(x=x_curve, y=y_curve, mode='lines', line=dict(color='black', width=2)))
            ...
            fig_hist.update_layout(height=350, margin=dict(l=10,r=10,t=40,b=10), template="plotly_white", 
        ...
        with col_box:
            ...
            fig_box.update_layout(height=350, margin=dict(l=10,r=10,t=40,b=10), template="plotly_white", 
